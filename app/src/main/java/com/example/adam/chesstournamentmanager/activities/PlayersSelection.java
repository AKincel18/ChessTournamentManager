...
public class PlayersSelection extends AppCompatActivity implements OnDialogFragmentClickListener {
    ...
    static private ArrayList<Player> availablePlayers = new ArrayList<>();
    static private ArrayList<Player> chosenPlayers = new ArrayList<>();
    ...
    private void movement(ArrayList<Player> add, ArrayList<Player> remove, ArrayList<Player> selected) {
        if (selected.isEmpty())
            ...
            ArrayAdapter<Player> adapter = new ArrayAdapter<>(this, R.layout.list_players, R.id.simple_checked_text_view, availablePlayers);
    ...
    private void removePlayer() {
        ...
        removePlayerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedAvailablePlayers.size() == 1) {
                    Player player = selectedAvailablePlayers.get(0);
    ...
    public void onOkClicked(GeneralDialogFragment dialog) {
        ...
        if (dialog.getTag().equals(getString(R.string.confirmation_removing_player))) {
            ...
            ArrayAdapter<Player> adapter = new ArrayAdapter<>(getApplicationContext(), R.layout.list_players, R.id.simple_checked_text_view, availablePlayers);
            allPlayersListView.setAdapter(adapter);
